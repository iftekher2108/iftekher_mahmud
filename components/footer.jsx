        ...
        <footer className="bg-dark text-white">
            <div className="footer-content p-5">
                <div className="footer-menu fw-bold d-flex small flex-lg-row flex-md-row flex-sm-column justify-content-center gap-3 my-lg-3 my-sm-1">
                    ...
                    <a href="#skill" className="nav-link my-sm-1 my-lg-0"> Learned Skill</a>
                    <a href="#contact" className="nav-link my-sm-1 my-lg-0"> Contact</a>
                </div>
                <div className="social-media d-flex flex-sm-wrap align-items-center justify-content-center gap-3 mb-2 py-2">
                    <a href="https://www.facebook.com/mdiftekher.mahmud/" className="nav-link rounded-circle p-1 px-2 text-white">
                    ...
                    <a href="https://wa.me/8801580359517" className="nav-link rounded-circle p-1 px-2 text-white">
                        <i className="fa-brands fs-5 fa-whatsapp" /></a>
                    <a href="https://github.com/iftekher2108" className="nav-link rounded-circle p-1 px-2 text-white"> <i className="fa-brands fs-5 fa-github" /></a>
