  ...
  return (
    <Layout>
      ...
      <div id="home" className="container-fluid overflow-hidden position-relative">
        ...
        <div className="row pt-3 m-0 h-100 overflow-hidden">
          ...
          <div className="hero-image col-lg-6  col-sm-12 my-2 m-0  p-lg-6 p-md-4 p-sm-3" data-aos="fade-left">
            <Image src="/image/3.jpg" height={500} width={1200} className="img-fluid" alt="hero-image" />
          </div>
        </div>
      </div>
      <div id="about-me">
          ...
          <div className="content-section px-5 py-4" data-aos="fade-up">
            <h2 className="text-center p-3
                     ...
                     border-start border-end
                      border-warning ">About Me</h2>

            <div className="row g-3 overflow-hidden mt-4">

              <div className="col-lg-6 col-md-6  col-sm-12">
                <Image src="/image/iftekher.jpg" height={500} width={500}
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="d-flex flex-column h-100 justify-content-center">
                  ...
                  <p className="text-justify fw-medium fs-6"> I am a professional Full Stack web developer
                    with
                    2+ years of experience crafting dynamic and user-friendly web
      ...
      <div id="service" className="m-0 overflow-hidden py-4">
        ...
        <div className="service-content m-0 mt-2 text-center overflow-hidden" data-aos="zoom-in">
      ...
      <div id="project" className="overflow-hidden bg-transparent">
        ...
        <div className="project-content" data-aos="zoom-in">
          ...
          <div className="mb-5 mx-lg-5 ms-md-3 ms-sm-2 px-lg-5 px-md-3 px-sm-2">
            <Link href="project" className="project-btn-link btn shadow text-white 
      ...
      <div id="skill" className="m-0 overflow-hidden p-0">
        ...
        <div className="skill-section p-5">
          ...
          <div className="card p-3" style={{ border: "2px solid #38bdf8" }}>
            <Image src="/image/tailwind-icon.png" height={100} width={100} className="bg-white mb-1 rounded-3"
          ...
          <div className="card p-3" style={{ border: "2px solid #0868AC" }}>
            <Image src="/image/jquery-icon.png" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #0868AC" }}
              alt="jquery-icon" />
            <h5>Jquery</h5>
          </div>
          ...
          <div className="card p-3" style={{ border: "2px solid #00678C" }}>
            <Image src="/image/mysql-icon.svg" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #00678C" }}
              alt="jquery-icon" />
            <h5>Mysql</h5>
          </div>
          ...
          <div className="card p-3" style={{ border: "2px solid #41B882" }}>
            <Image src="/image/vue.jpeg" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #41B882" }} alt="icon" />
            <h5>Vue</h5>
          </div>

          <div className="card p-3" style={{ border: "2px solid #08D9FF" }}>
            <i className="fa-brands mb-1 fa-react" style={{ color:'#08D9FF' }}></i>
            <h5>React</h5>
          </div>

          <div className="card p-3" style={{ border: "2px solid #F2F3EE" }}>
            <Image src="/image/nextjs.png" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #F2F3EE" }} alt="icon" />
            <h5>Next js</h5>
          </div>
          
          <div className="card p-3" style={{ border: "2px solid #7E67ED" }}>
            <Image src="/image/inertia.jpeg" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #7E67ED" }} alt="icon" />
            <h5>Inertia</h5>
          </div>


          <div className="card p-3" style={{ border: "2px solid #0087CB" }}>
            <Image src="/image/dart.png" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #00D2B8" }} alt="icon" />
            <h5>Dart</h5>
          </div>


          <div className="card p-3" style={{ border: "2px solid #29B4F4" }}>
            <Image src="/image/flutter.png" height={100} width={100} className="bg-white mb-1 rounded-3" style={{ border: "2px solid #29B4F4" }} alt="icon" />
            <h5>Flutter</h5>
          </div>
